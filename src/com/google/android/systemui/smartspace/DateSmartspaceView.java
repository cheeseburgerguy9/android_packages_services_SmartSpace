...
public class DateSmartspaceView
  ...
  public static final boolean DEBUG =
      Log.isLoggable("DateSmartspaceView", Log.DEBUG);
  ...
  public DateSmartspaceView(Context context) { this(context, null); }

  @Override
  public final void onAttachedToWindow() {
    Handler handler;
    super.onAttachedToWindow();
    if (TextUtils.equals(mUiSurface,
    ...
    BcSmartSpaceUtil.setOnClickListener(
        mDateView, mDateTarget, mDateAction,
  ...
  public final void setDnd(Drawable image, String description) {
    if (image == null) {
      ...
      BcSmartspaceTemplateDataUtils.updateVisibility(mDndImageView,
                                                     View.VISIBLE);
    }
   ...
   * line is 1 */
  @Override
  // com.android.systemui.plugins.BcSmartspaceDataPlugin.SmartspaceView
    ...
    if (loggingSurface != 3 || mIsAodEnabled) {
      ...
      if (mNextAlarmData.mImage != null) {
        BcSmartspaceCardLoggingInfo.Builder alarmBuilder =
            new BcSmartspaceCardLoggingInfo.Builder()
                .setInstanceId(
                    InstanceId.create("upcoming_alarm_card_94510_12684"))
                .setFeatureType(23)
                .setDisplaySurface(loggingSurface)
                .setUid(mLoggingInfo.mUid);
  ...
  public final void setNextAlarm(Drawable image, String description) {
    ...
    if (mNextAlarmData.mImage == null) {
      BcSmartspaceTemplateDataUtils.updateVisibility(mNextAlarmTextView,
                                                     View.GONE);
    } else {
      mNextAlarmTextView.setContentDescription(getContext().getString(
          R.string.accessibility_next_alarm, description));
      String displayText = TextUtils.isEmpty(null)
      ...
      mNextAlarmTextView.setCompoundDrawablesRelative(mNextAlarmIconDrawable,
                                                      null, null, null);
      BcSmartspaceTemplateDataUtils.updateVisibility(mNextAlarmTextView,
                                                     View.VISIBLE);
      ...
      BcSmartspaceCardLoggingInfo loggingInfo =
          new BcSmartspaceCardLoggingInfo.Builder()
              ...
              .build();
      BcSmartSpaceUtil.setOnClickListener(
          mNextAlarmTextView, null, BcNextAlarmData.SHOW_ALARMS_ACTION,
          eventNotifier, "BcNextAlarmData", loggingInfo, 0);
    }
    updateColorForExtras();
  }
