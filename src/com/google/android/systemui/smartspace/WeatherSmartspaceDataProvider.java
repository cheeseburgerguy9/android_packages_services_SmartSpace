...
public final class WeatherSmartspaceDataProvider
  ...
  public final Set<SmartspaceTargetListener> mSmartspaceTargetListeners =
      new HashSet<>();
  ...
  getLargeClockView(Context context) {
    View view = LayoutInflater.from(context).inflate(R.layout.weather_large,
  ...
  public final BcSmartspaceDataPlugin.SmartspaceView getView(Context context) {
    return (BcSmartspaceDataPlugin.SmartspaceView)LayoutInflater.from(context)
