      ...
      if (extras.containsKey("cardPrompt")) {
        ...
        if (textView == null) {
          Log.w("BcSmartspaceCardShoppingList",
                "No card prompt view to update");
        } else {
          textView.setText(string);
        }
        BcSmartspaceTemplateDataUtils.updateVisibility(mCardPromptView, 0);
        if (bitmap != null) {
          BcSmartspaceTemplateDataUtils.updateVisibility(mCardPromptIconView,
                                                         0);
          return true;
        }
      } else {
        if (extras.containsKey("emptyListString")) {
          ...
          BcSmartspaceTemplateDataUtils.updateVisibility(mEmptyListMessageView,
                                                         0);
