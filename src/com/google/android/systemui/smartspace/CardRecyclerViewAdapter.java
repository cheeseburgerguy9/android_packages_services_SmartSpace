...
public final class CardRecyclerViewAdapter
  ...
  public static final Set<Integer> legacySecondaryCardResourceIdSet =
      BcSmartSpaceUtil.FEATURE_TYPE_TO_SECONDARY_CARD_RESOURCE_MAP.values()
          .stream()
  ...
  /* compiled from: go/retraceme
   * af8e0b46c0cb0ee2c99e9b6d0c434e5c0b686fd9230eaab7fb9a40e3a9d0cf6f */
  public final class DiffUtilItemCallback
      extends DiffUtil.ItemCallback<SmartspaceTarget> {
    @Override // androidx.recyclerview.widget.DiffUtil.Callback
    public final boolean areItemsTheSame(SmartspaceTarget oldItem,
                                         SmartspaceTarget newItem) {
      return oldItem.getSmartspaceTargetId().equals(
          newItem.getSmartspaceTargetId());
    }

    @Override // androidx.recyclerview.widget.DiffUtil.Callback
    public final boolean areContentsTheSame(SmartspaceTarget oldItem,
                                            SmartspaceTarget newItem) {
      return false;
    }
  }
   ...
   * line is 1 */
  public CardRecyclerViewAdapter(BcSmartspaceView root,
    ...
    dozeColor = -1;
    int attrColor = GraphicsUtils.getAttrColor(root.getContext(),
    ...
    if (!isTemplateCard(target)) {
      Integer layoutId =
          (Integer)BcSmartSpaceUtil.FEATURE_TYPE_TO_SECONDARY_CARD_RESOURCE_MAP
              .get(BcSmartSpaceUtil.getFeatureType(target));
  ...
  @Override
  public BcSmartspaceRemoteViewsCard
  ...
  public final void onBindViewHolder(ViewHolder holder, int position) {
    ...
    if (target.getRemoteViews() != null) {
      if (!(card instanceof BcSmartspaceRemoteViewsCard)) {
        Log.w("SsCardRecyclerViewAdapter",
      ...
      if (!(card instanceof BaseTemplateCard)) {
        Log.w("SsCardRecyclerViewAdapter",
              "No ui-template card view can be binded");
        return;
      }
    ...
    if (templateSecondaryCardResourceIdSet.contains(viewType) ||
      ...
      if (nonRemoteViewsHorizontalPadding != null) {
        templateCard.setPaddingRelative(
            nonRemoteViewsHorizontalPadding, templateCard.getPaddingTop(),
      ...
      if (legacySecondaryCardResourceIdSet.contains(viewType) ||
        ...
        if (nonRemoteViewsHorizontalPadding != null) {
          legacyCard.setPaddingRelative(
              nonRemoteViewsHorizontalPadding, legacyCard.getPaddingTop(),
  ...
  public final void setNonRemoteViewsHorizontalPadding(Integer padding) {
    ...
    for (int i = 0; i < viewHolders.size(); i++) {
      ...
      if (legacyCard != null) {
        legacyCard.setPaddingRelative(padding, legacyCard.getPaddingTop(),
                                      padding, legacyCard.getPaddingBottom());
      }
      BaseTemplateCard templateCard = getTemplateCardAtPosition(key);
      if (templateCard != null) {
        templateCard.setPaddingRelative(padding, templateCard.getPaddingTop(),
                                        padding,
    ...
    while (it.hasNext()) {
      ...
      if (smartspaceTarget.getFeatureType() == 34 ||
        ...
        Log.e("SsCardRecyclerViewAdapter",
              "No card can be created for target: " +
