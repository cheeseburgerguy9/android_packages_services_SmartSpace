...
public abstract class BcSmartspaceCardLogger {
  static { FalsingManager falsingManager = BcSmartSpaceUtil.sFalsingManager; }

  public static void log(BcSmartspaceEvent event,
    ...
    if (subcardInfo != null && subcardInfo.mSubcards != null &&
      ...
      List<SmartspaceProtoLite.SmartSpaceCardMetadata> subcardMetadataList =
          new ArrayList<>();
      for (BcSmartspaceCardMetadataLoggingInfo metadata :
           subcardInfo.mSubcards) {
    ...
    if (loggingInfo.mDimensionalInfo != null) {
      dimensionalInfoData =
          MessageNano.toByteArray(loggingInfo.mDimensionalInfo);
    }
