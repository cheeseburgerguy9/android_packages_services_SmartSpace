...
public final class BcSmartspaceCardLoggingInfo {
  ...
  public final boolean equals(Object obj) {
    ...
    return mInstanceId == other.mInstanceId &&
        mDisplaySurface == other.mDisplaySurface && mRank == other.mRank &&
        mCardinality == other.mCardinality &&
        mFeatureType == other.mFeatureType &&
        mReceivedLatency == other.mReceivedLatency && mUid == other.mUid &&
        Objects.equals(mSubcardInfo, other.mSubcardInfo) &&
        Objects.equals(mDimensionalInfo, other.mDimensionalInfo);
  }

  public final int hashCode() {
    return Objects.hash(mInstanceId, mDisplaySurface, mRank, mCardinality,
                        mFeatureType, mReceivedLatency, mUid, mSubcardInfo);
  }
  ...
  public final String toString() {
    return "instance_id = " + mInstanceId + ", feature type = " + mFeatureType +
        ...
        ", subcardInfo = " + mSubcardInfo +
        ", dimensionalInfo = " + mDimensionalInfo;
  }
}
