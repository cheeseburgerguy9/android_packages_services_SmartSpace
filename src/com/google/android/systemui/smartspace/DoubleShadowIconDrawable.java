...
public final class DoubleShadowIconDrawable extends Drawable {
  ...
  public final void setIcon(Drawable drawable) {
    ...
    if (mIconDrawable != null) {
      ...
      RenderEffect ambientShadowEffect = RenderEffect.createColorFilterEffect(
          new PorterDuffColorFilter(Color.argb(48, 0, 0, 0),
      ...
      RenderEffect keyShadowEffect = RenderEffect.createColorFilterEffect(
          new PorterDuffColorFilter(Color.argb(72, 0, 0, 0),
                                    PorterDuff.Mode.MULTIPLY),
          RenderEffect.createOffsetEffect(
              mKeyShadowOffsetX, mKeyShadowOffsetY,
              RenderEffect.createBlurEffect(mKeyShadowRadius, mKeyShadowRadius,
                                            Shader.TileMode.CLAMP)));
  ...
  public DoubleShadowIconDrawable(int iconSize, int insetSize,
                                  Context context) {
    mShowShadow = true;
    mIconInsetSize = insetSize;
    mCanvasSize = insetSize * 2 + iconSize;
    mAmbientShadowRadius = context.getResources().getDimensionPixelSize(
        R.dimen.ambient_text_shadow_radius);
    mKeyShadowRadius = context.getResources().getDimensionPixelSize(
        R.dimen.key_text_shadow_radius);
    mKeyShadowOffsetX = context.getResources().getDimensionPixelSize(
        R.dimen.key_text_shadow_dx);
    mKeyShadowOffsetY = context.getResources().getDimensionPixelSize(
        R.dimen.key_text_shadow_dy);
