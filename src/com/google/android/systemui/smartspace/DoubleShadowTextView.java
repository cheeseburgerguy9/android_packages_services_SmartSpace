...
public class DoubleShadowTextView extends TextView {
  ...
  public DoubleShadowTextView(Context context) { this(context, null); }
  ...
  public final void onDraw(Canvas canvas) {
    ...
    getPaint().setShadowLayer(mAmbientShadowBlur, 0.0f, 0.0f,
                              mAmbientShadowColor);
    super.onDraw(canvas);
    canvas.save();
    canvas.clipRect(getScrollX(), getExtendedPaddingTop() + getScrollY(),
                    getWidth() + getScrollX(), getHeight() + getScrollY());
    getPaint().setShadowLayer(mKeyShadowBlur, mKeyShadowOffsetX,
                              mKeyShadowOffsetY, mKeyShadowColor);
    super.onDraw(canvas);
    canvas.restore();
  }
  ...
  public DoubleShadowTextView(Context context, AttributeSet attrs,
    ...
    mKeyShadowBlur = context.getResources().getDimensionPixelSize(
    ...
    mKeyShadowColor =
        context.getResources().getColor(R.color.key_text_shadow_color);
