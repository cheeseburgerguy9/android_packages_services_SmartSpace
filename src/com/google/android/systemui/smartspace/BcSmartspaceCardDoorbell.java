...
public class BcSmartspaceCardDoorbell extends BcSmartspaceCardGenericImage {
  ...
  public BcSmartspaceCardDoorbell(Context context) { this(context, null); }
  ...
  public void resetUi() {
    ...
    BcSmartspaceTemplateDataUtils.updateVisibility(mLoadingScreenView,
                                                   View.GONE);
  ...
  public boolean setSmartspaceActions(
    ...
    if (!imageUris.isEmpty()) {
      ...
      WeakReference<ViewGroup> loadingScreenRef =
          new WeakReference<>(mLoadingScreenView);
      ...
      if (bitmap != null && bitmap.getHeight() != 0) {
        ...
        bitmap = Bitmap.createScaledBitmap(bitmap, (int)(height * aspectRatio),
                                           height, true);
      ...
      boolean progressBarVisible =
          (state == 1 ||
           (state == 4 && extras.getBoolean("progressBarVisible", true)));
      ...
      if (state == 2) {
        mLoadingIcon.setImageDrawable(
            getContext().getDrawable(R.drawable.videocam));
        iconVisible = true;
      } else if (state == 3) {
        mLoadingIcon.setImageDrawable(
            getContext().getDrawable(R.drawable.videocam_off));
        iconVisible = true;
  ...
  public static class DrawableWithUri extends DrawableWrapper {
    ...
    public DrawableWithUri(Uri uri, ContentResolver contentResolver,
                           int heightInPx, float scaledCornerRadius,
    ...
    protected void onBoundsChange(Rect bounds) {
      ...
      mClipPath.reset();
      mClipPath.addRoundRect(mTempRect, mScaledCornerRadius,
                             mScaledCornerRadius, Path.Direction.CCW);
  ...
  public static class LoadUriTask
      extends AsyncTask<DrawableWithUri, Void, DrawableWithUri> {
    ...
    protected void onPostExecute(DrawableWithUri result) {
      ...
      if (loadingScreen != null) {
        BcSmartspaceTemplateDataUtils.updateVisibility(loadingScreen,
                                                       View.GONE);
      }
    }
