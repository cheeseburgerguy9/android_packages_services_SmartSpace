...
public class WeatherSmartspaceView extends LinearLayout
  ...
  public static final boolean DEBUG =
      Log.isLoggable("WeatherSmartspaceView", Log.DEBUG);
  ...
  public WeatherSmartspaceView(Context context) { this(context, null); }
      ...
      if (!hasValidTemplate) {
        ...
        if (headerAction == null) {
          ...
          ContentDescriptionUtil.setFormattedContentDescription(
              "WeatherSmartspaceView", mView, headerAction.getTitle(),
              headerAction.getContentDescription());
          if (!TextUtils.equals(mUiSurface,
                                BcSmartspaceDataPlugin.UI_SURFACE_DREAM)) {
            BcSmartSpaceUtil.setOnClickListener(
                mView, target, headerAction,
        ...
        if (subItemInfo == null) {
          ...
          if (subItemInfo.getTapAction() != null &&
              !TextUtils.equals(mUiSurface,
                                BcSmartspaceDataPlugin.UI_SURFACE_DREAM)) {
            BcSmartSpaceUtil.setOnClickListener(
                mView, target, subItemInfo.getTapAction(),
                mDataProvider != null ? mDataProvider.getEventNotifier() : null,
                "WeatherSmartspaceView", mLoggingInfo, 0);
          }
        }
  ...
  public WeatherSmartspaceView(Context context, AttributeSet attrs,
    ...
    try {
      int iconSize = obtainStyledAttributes.getDimensionPixelSize(
          1, context.getResources().getDimensionPixelSize(
                 R.dimen.enhanced_smartspace_icon_size));
      int iconInset = obtainStyledAttributes.getDimensionPixelSize(
      ...
      mIconSize = iconSize;
      mIconDrawable =
          new DoubleShadowIconDrawable(iconSize, iconInset, context);
    } catch (Throwable th) {
      obtainStyledAttributes.recycle();
      throw th;
    }
