...
/* compiled from: go/retraceme
 * af8e0b46c0cb0ee2c99e9b6d0c434e5c0b686fd9230eaab7fb9a40e3a9d0cf6f */
/* loaded from: classes2.dex */
public class BcSmartspaceCard
   ...
   * line is 1 */
  public BcSmartspaceCard(Context context) { this(context, null); }

   * line is 1 */
  public static int
  getClickedIndex(BcSmartspaceCardLoggingInfo bcSmartspaceCardLoggingInfo,
                  int i) {
    List list;
    ...
    if (bcSmartspaceSubcardLoggingInfo != null &&
      ...
      while (true) {
        ...
        BcSmartspaceCardMetadataLoggingInfo
            bcSmartspaceCardMetadataLoggingInfo =
  ...
  public final void bindData(
    ...
    BcSmartspaceTemplateDataUtils.updateVisibility(
        this.mBaseActionIconSubtitleView, 8);
    ...
    if (headerAction != null) {
      ...
      boolean z3 =
          smartspaceTarget.getFeatureType() == 1 || !TextUtils.isEmpty(title);
    ...
    if (baseAction != null) {
      ...
      if (baseAction.getIcon() != null) {
        ...
        drawable = BcSmartSpaceUtil.getIconDrawableWithCustomSize(
            icon2, context2,
            context2.getResources().getDimensionPixelSize(
                R.dimen.enhanced_smartspace_icon_size));
      }
      this.mBaseActionIconDrawable.setIcon(drawable);
      setBaseActionIconSubtitle(baseAction.getSubtitle(),
      ...
      BcSmartSpaceUtil.setOnClickListener(
          this.mBaseActionIconSubtitleView, smartspaceTarget, baseAction,
    ...
    updateIconTint();
    if (headerAction == null || (headerAction.getIntent() == null &&
                                 headerAction.getPendingIntent() == null)) {
      ...
      if (smartspaceAction2 == null ||
        ...
        if (headerAction != null) {
          BcSmartSpaceUtil.setOnClickListener(
              this, smartspaceTarget, headerAction, this.mEventNotifier,
              "BcSmartspaceCard", bcSmartspaceCardLoggingInfo, 0);
        }
      } else if (smartspaceAction2 != null) {
        BcSmartSpaceUtil.setOnClickListener(
            this, smartspaceTarget, smartspaceAction2, this.mEventNotifier,
            "BcSmartspaceCard", bcSmartspaceCardLoggingInfo, 0);
      }
    } else {
      ...
      if (headerAction != null) {
        BcSmartSpaceUtil.setOnClickListener(
            this, smartspaceTarget, headerAction, this.mEventNotifier,
            "BcSmartspaceCard", bcSmartspaceCardLoggingInfo2, 0);
      }
    }
   ...
   * line is 1 */
  @Override
  // androidx.constraintlayout.widget.ConstraintLayout, android.view.ViewGroup,
  // android.view.View
  public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
    ...
    if (z || this.mTouchDelegateIsDirty) {
      ...
      DoubleShadowTextView doubleShadowTextView =
          this.mBaseActionIconSubtitleView;
      if (doubleShadowTextView == null ||
          doubleShadowTextView.getVisibility() != 0) {
        return;
      }
      int dimensionPixelSize = (getResources().getDimensionPixelSize(
                                    R.dimen.subtitle_hit_rect_height) -
                                this.mBaseActionIconSubtitleView.getHeight()) /
                               2;
      this.mBaseActionIconSubtitleView.getHitRect(
      ...
      if (dimensionPixelSize > 0 ||
        ...
        this.mBaseActionIconSubtitleHitRect.bottom = getHeight();
        setTouchDelegate(new TouchDelegate(this.mBaseActionIconSubtitleHitRect,
                                           this.mBaseActionIconSubtitleView));
      }
    }
  }
   ...
   * line is 1 */
  public final void setBaseActionIconSubtitle(CharSequence charSequence,
    ...
    BcSmartspaceTemplateDataUtils.updateVisibility(
        this.mBaseActionIconSubtitleView, 0);
    this.mBaseActionIconSubtitleView.setText(charSequence);
    this.mBaseActionIconSubtitleView.setCompoundDrawablesRelative(
        drawable, null, null, null);
    ContentDescriptionUtil.setFormattedContentDescription(
        "BcSmartspaceCard", this.mBaseActionIconSubtitleView, charSequence,
        charSequence2);
  }
  ...
  public final void setDozeAmount(float f) {
    ...
    if (smartspaceTarget != null && smartspaceTarget.getBaseAction() != null &&
      ...
      if (this.mTitleTextView != null &&
          extras.getBoolean("hide_title_on_aod")) {
    ...
    if (smartspaceTarget2 == null || smartspaceTarget2.getFeatureType() != 30) {
      ...
      this.mTextGroup.setTranslationX(
          ((PathInterpolator)Interpolators.EMPHASIZED)
              .getInterpolation(this.mDozeAmount) *
          this.mSecondaryCardGroup.getWidth() * (isRtl() ? 1 : -1));
      this.mSecondaryCardGroup.setAlpha(Math.max(
          0.0f, Math.min(1.0f, ((1.0f - this.mDozeAmount) * 9.0f) - 6.0f)));
    }
  }
  ...
  public final void setSubtitle(CharSequence text,
    ...
    mSubtitleTextView.setCompoundDrawablesRelative(
        (TextUtils.isEmpty(text) || !useIcon) ? null : mIconDrawable, null,
        null, null);
    mSubtitleTextView.setMaxLines((mTarget == null ||
                                   mTarget.getFeatureType() != 5 ||
                                   mUsePageIndicatorUi)
                                      ? 1
                                      : 2);
    ContentDescriptionUtil.setFormattedContentDescription(
   ...
   * line is 1 */
  public final void setTitle(CharSequence text, CharSequence contentDescription,
                             boolean useIcon) {
    boolean z2;
    ...
    SmartspaceAction headerAction =
        mTarget == null ? null : mTarget.getHeaderAction();
    ...
    if (extras == null || !extras.containsKey("titleEllipsize")) {
      ...
      try {
        ...
        Log.w("BcSmartspaceCard", "Invalid TruncateAt value: " +
                                      extras.getString("titleEllipsize"));
      }
    }
    boolean z3 = false;
    if (extras != null) {
    ...
    mTitleTextView.setCompoundDrawablesRelative(z3 ? mIconDrawable : null, null,
                                                null, null);
    BcSmartspaceTemplateDataUtils.offsetTextViewForIcon(
