...
public abstract class BcSmartSpaceUtil {
  ...
  public static class InteractionHandler
    ...
    onInteraction(View view, PendingIntent pendingIntent,
                  RemoteViews.RemoteResponse remoteResponse) {
      BcSmartspaceDataPlugin.IntentStarter intentStarter =
          BcSmartSpaceUtil.getIntentStarter(eventNotifier,
                                            "BcSmartspaceRemoteViewsCard");
      if (pendingIntent != null) {
        BcSmartspaceCardLogger.log(BcSmartspaceEvent.SMARTSPACE_CARD_CLICK,
                                   loggingInfo);
  ...
  public static class DefaultIntentStarter
      implements BcSmartspaceDataPlugin.IntentStarter {
    public final String tag;

    public DefaultIntentStarter(String tag) { this.tag = tag; }

    @Override
    public final void startIntent(View view, Intent intent,
    ...
    @Override
    public final void startPendingIntent(View view, PendingIntent pendingIntent,
                                         boolean showOnLockscreen) {
      try {
        pendingIntent.send();
  ...
  static {
    FEATURE_TYPE_TO_SECONDARY_CARD_RESOURCE_MAP = Map.ofEntries(
        ...
        Map.entry(3, Integer.valueOf(
                         R.layout.smartspace_card_generic_landscape_image)),
        Map.entry(18, Integer.valueOf(
                          R.layout.smartspace_card_generic_landscape_image)),
        ...
        Map.entry(10,
                  Integer.valueOf(R.layout.smartspace_card_weather_forecast)),
  ...
  public static String getDimensionRatio(Bundle bundle) {
    if (!bundle.containsKey("imageRatioWidth") ||
  ...
  getIconDrawableWithCustomSize(Icon icon, Context context, int size) {
    if (icon == null) {
      return null;
    }
    Drawable drawable =
  ...
  public static BcSmartspaceDataPlugin.IntentStarter
  getIntentStarter(BcSmartspaceDataPlugin.SmartspaceEventNotifier eventNotifier,
                   String tag) {
    BcSmartspaceDataPlugin.IntentStarter intentStarter =
  ...
  public static int getLoggingDisplaySurface(String uiSurface,
                                             float dozeAmount) {
    if (uiSurface == null) {
      return 0;
    }
  ...
  public static void setOnClickListener(
      View view, SmartspaceTarget target, SmartspaceAction action,
    ...
    boolean isNoIntent =
        action.getIntent() == null && action.getPendingIntent() == null;
    boolean showOnLockscreen =
        action.getExtras() != null &&
        action.getExtras().getBoolean("show_on_lockscreen");
    BcSmartspaceDataPlugin.IntentStarter intentStarter =
    ...
    view.setOnClickListener(v -> {
      ...
      if (eventNotifier == null) {
        Log.w(tag, "Cannot notify target interaction smartspace event: event " +
                   "notifier null.");
      } else {
        eventNotifier.notifySmartspaceEvent(
            new SmartspaceTargetEvent
  ...
  public static void setOnClickListener(
      View view, SmartspaceTarget target, TapAction tapAction,
      BcSmartspaceDataPlugin.SmartspaceEventNotifier eventNotifier, String tag,
      BcSmartspaceCardLoggingInfo loggingInfo, int index) {
