...
public class HeadToHeadTemplateCard extends BcSmartspaceCardSecondary {
  ...
  public HeadToHeadTemplateCard(Context context) { super(context); }
  ...
  public final void resetUi() {
    ...
    BcSmartspaceTemplateDataUtils.updateVisibility(mFirstCompetitorText,
                                                   View.GONE);
    BcSmartspaceTemplateDataUtils.updateVisibility(mSecondCompetitorText,
                                                   View.GONE);
    BcSmartspaceTemplateDataUtils.updateVisibility(mFirstCompetitorIcon,
                                                   View.GONE);
    BcSmartspaceTemplateDataUtils.updateVisibility(mSecondCompetitorIcon,
                                                   View.GONE);
  }
  ...
  public boolean setSmartspaceActions(
    ...
    HeadToHeadTemplateData templateData =
        (HeadToHeadTemplateData)target.getTemplateData();
    ...
    if (title != null) {
      if (mHeadToHeadTitle == null) {
        ...
        BcSmartspaceTemplateDataUtils.updateVisibility(mHeadToHeadTitle,
                                                       View.VISIBLE);
        isValid = true;
      }
    }
    ...
    if (firstCompetitorText != null) {
      if (mFirstCompetitorText == null) {
        Log.w("HeadToHeadTemplateCard",
              "No first competitor text view to update");
      } else {
        BcSmartspaceTemplateDataUtils.setText(mFirstCompetitorText,
                                              firstCompetitorText);
        BcSmartspaceTemplateDataUtils.updateVisibility(mFirstCompetitorText,
                                                       View.VISIBLE);
        isValid = true;
    ...
    Text secondCompetitorText =
        templateData.getHeadToHeadSecondCompetitorText();
    if (secondCompetitorText != null) {
      if (mSecondCompetitorText == null) {
        Log.w("HeadToHeadTemplateCard",
              "No second competitor text view to update");
      } else {
        BcSmartspaceTemplateDataUtils.setText(mSecondCompetitorText,
                                              secondCompetitorText);
        BcSmartspaceTemplateDataUtils.updateVisibility(mSecondCompetitorText,
                                                       View.VISIBLE);
        isValid = true;
      }
    ...
    if (firstCompetitorIcon != null) {
      if (mFirstCompetitorIcon == null) {
        Log.w("HeadToHeadTemplateCard",
              "No first competitor icon view to update");
      } else {
        BcSmartspaceTemplateDataUtils.setIcon(mFirstCompetitorIcon,
                                              firstCompetitorIcon);
        BcSmartspaceTemplateDataUtils.updateVisibility(mFirstCompetitorIcon,
                                                       View.VISIBLE);
        isValid = true;
    ...
    Icon secondCompetitorIcon =
        templateData.getHeadToHeadSecondCompetitorIcon();
    if (secondCompetitorIcon != null) {
      if (mSecondCompetitorIcon == null) {
        Log.w("HeadToHeadTemplateCard",
              "No second competitor icon view to update");
      } else {
        BcSmartspaceTemplateDataUtils.setIcon(mSecondCompetitorIcon,
                                              secondCompetitorIcon);
        BcSmartspaceTemplateDataUtils.updateVisibility(mSecondCompetitorIcon,
                                                       View.VISIBLE);
        isValid = true;
      }
    ...
    if (isValid && templateData.getHeadToHeadAction() != null) {
      BcSmartSpaceUtil.setOnClickListener(
          this, target, templateData.getHeadToHeadAction(), eventNotifier,
          "HeadToHeadTemplateCard", loggingInfo, 0);
    }
