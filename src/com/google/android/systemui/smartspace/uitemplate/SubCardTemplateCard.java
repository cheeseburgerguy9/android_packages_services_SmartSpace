...
public class SubCardTemplateCard extends BcSmartspaceCardSecondary {
  ...
  public SubCardTemplateCard(Context context) { super(context); }
  ...
  public boolean setSmartspaceActions(
    ...
    SubCardTemplateData templateData =
        (SubCardTemplateData)target.getTemplateData();
    if (!BcSmartspaceCardLoggerUtil.containsValidTemplateType(templateData)) {
      Log.w("SubCardTemplateCard",
            "SubCardTemplateData is null or invalid template type");
      return false;
    }
    ...
    if (isValid && templateData.getSubCardAction() != null) {
      BcSmartSpaceUtil.setOnClickListener(
          this, target, templateData.getSubCardAction(), eventNotifier,
          "SubCardTemplateCard", loggingInfo, 0);
    }
