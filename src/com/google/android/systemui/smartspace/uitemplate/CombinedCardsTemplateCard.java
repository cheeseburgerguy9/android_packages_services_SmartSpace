...
public class CombinedCardsTemplateCard extends BcSmartspaceCardSecondary {
  ...
  public CombinedCardsTemplateCard(Context context) { super(context); }
  ...
  public final boolean setSmartspaceActions(
    ...
    List<BaseTemplateData> combinedCardDataList =
        templateData.getCombinedCardDataList();
    ...
    return setupSubCard(mFirstSubCard, firstCardData, target, eventNotifier,
                        loggingInfo) &&
        (secondCardData == null ||
  ...
  setupSubCard(ViewGroup container, BaseTemplateData templateData,
               SmartspaceTarget target,
               BcSmartspaceDataPlugin.SmartspaceEventNotifier eventNotifier,
               BcSmartspaceCardLoggingInfo loggingInfo) {
    ...
    if (subCardResId == 0) {
      BcSmartspaceTemplateDataUtils.updateVisibility(container, View.GONE);
      Log.w("CombinedCardsTemplateCard",
            "Combined sub-card res is null. Cannot set it up");
      return false;
    }
    ...
    subCard.setSmartspaceActions(new SmartspaceTarget
                                     .Builder(target.getSmartspaceTargetId(),
