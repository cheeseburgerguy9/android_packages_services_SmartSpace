...
public class BcSmartspaceCardLoyalty extends BcSmartspaceCardGenericImage {
  ...
  public BcSmartspaceCardLoyalty(Context context) { super(context); }
  @Override
  ...
  public final boolean setSmartspaceActions(
    ...
    if (!extras.containsKey("loyaltyProgramName")) {
      if (containsKey) {
        BcSmartspaceTemplateDataUtils.updateVisibility(mLoyaltyProgramLogoView,
                                                       0);
      }
      return containsKey;
    }
    ...
    if (textView2 == null) {
      Log.w("BcSmartspaceCardLoyalty",
            "No loyalty program name view to update");
    } else {
