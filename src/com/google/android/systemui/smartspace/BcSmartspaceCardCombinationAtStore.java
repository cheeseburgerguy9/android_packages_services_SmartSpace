...
public class BcSmartspaceCardCombinationAtStore
    extends BcSmartspaceCardCombination {
  public BcSmartspaceCardCombinationAtStore(Context context) { super(context); }
  ...
  public final boolean setSmartspaceActions(
    ...
    boolean z2 = constraintLayout2 != null &&
                 fillSubCard(constraintLayout2, target, action, eventNotifier,
                             loggingInfo);
    if (z) {
      this.mFirstSubCard.setBackgroundResource(
          R.drawable.bg_smartspace_combination_sub_card);
    }
    return z && z2;
  }
