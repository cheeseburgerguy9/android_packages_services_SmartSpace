...
public final class LazyServerFlagLoader {
  ...
  public LazyServerFlagLoader(String str) { mPropertyKey = str; }

  public boolean get() {
    if (mValue == null) {
      mValue = Boolean.valueOf(
          DeviceConfig.getBoolean("launcher", mPropertyKey, true));
      DeviceConfig.addOnPropertiesChangedListener(
          "launcher", Executors.newSingleThreadExecutor(),
  ...
  private static class OnPropertiesChangedListener
    ...
    public void onPropertiesChanged(DeviceConfig.Properties properties) {
      ...
      if (keyset.contains(str)) {
        lazyServerFlagLoader.mValue =
            Boolean.valueOf(properties.getBoolean(str, true));
      }
    }
  }
}
