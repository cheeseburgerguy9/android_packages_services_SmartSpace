...
public final class PagerDots extends View {
  ...
  public final void onDraw(Canvas canvas) {
    ...
    try {
      canvas.scale(isLayoutRtl() ? -1.0f : 1.0f, 1.0f, canvas.getWidth() * 0.5f,
                   0.0f);
      ...
      for (int i5 = 0; i5 < numPages; i5++) {
        ...
        float f5 = i5 == i6       ? activeDotSize - f4
                   : i5 == i6 + 1 ? dotSize + f4
                                  : dotSize;
  ...
  public final void setNumPages(int i, boolean z) {
    ...
    if (i <= 0) {
      Log.w("SsPagerDots",
            "Total number of pages invalid: " + i + ". Assuming 1 page.");
      numPages = 1;
    } else {
      numPages = i;
    }
  ...
  public final void updateCurrentPageIndex(int i) {
    ...
    setContentDescription(
        getContext().getString(R.string.accessibility_smartspace_page,
                               currentPageIndex + 1, numPages));
  }

  public PagerDots(Context context) { this(context, null); }
}
