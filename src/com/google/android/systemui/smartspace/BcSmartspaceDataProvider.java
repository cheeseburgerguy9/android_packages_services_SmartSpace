...
public final class BcSmartspaceDataProvider implements BcSmartspaceDataPlugin {
  public static final boolean DEBUG =
      Log.isLoggable(BcSmartspaceDataPlugin.TAG, 3);

  public final View.OnAttachStateChangeListener mStateChangeListener;
  public final Set<BcSmartspaceDataPlugin.SmartspaceTargetListener>
      mSmartspaceTargetListeners = new CopyOnWriteArraySet<>();
  ...
  public void onTargetsAvailable(List<SmartspaceTarget> list) {
    if (DEBUG) {
      Log.d(BcSmartspaceDataPlugin.TAG,
  ...
  @Override
  public void
  registerListener(BcSmartspaceDataPlugin.SmartspaceTargetListener listener) {
  ...
  @Override
  public void
  unregisterListener(BcSmartspaceDataPlugin.SmartspaceTargetListener listener) {
    mSmartspaceTargetListeners.remove(listener);
  }

  @Override
  public void setEventDispatcher(
      BcSmartspaceDataPlugin.SmartspaceEventDispatcher dispatcher) {
