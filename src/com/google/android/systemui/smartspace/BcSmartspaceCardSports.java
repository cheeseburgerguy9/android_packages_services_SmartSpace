...
public class BcSmartspaceCardSports extends BcSmartspaceCardSecondary {
  ...
  public BcSmartspaceCardSports(Context context) { super(context); }
  ...
  public final boolean setSmartspaceActions(
    ...
    if (extras.containsKey("firstCompetitorScore")) {
      ...
      if (textView2 == null) {
        Log.w("BcSmartspaceCardSports",
              "No first competitor logo view to update");
      } else {
    ...
    if (extras.containsKey("secondCompetitorScore")) {
      ...
      if (textView3 == null) {
        Log.w("BcSmartspaceCardSports",
              "No second competitor logo view to update");
      } else {
